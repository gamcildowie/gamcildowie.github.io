...
// Update time
  function update() {
    ...
    function checkHalfSecond(momentSecond){
      if(momentSecond < 10) {halfSecond = 'tenS';}
      else if(momentSecond < 20) {halfSecond = 'twentyS';}
      else if(momentSecond < 30) {halfSecond = 'thirtyS';}
      else if(momentSecond < 40) {halfSecond = 'fortyS';}
      else if(momentSecond < 50) {halfSecond = 'fiftyS';}
      else {halfSecond = 'sixtyS';}
    }
